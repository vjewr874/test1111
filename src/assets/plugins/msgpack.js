...
var h = t("./bufferish"), l = 2048, p = 65536, d = "BUFFER_SHORTAGE";
n.mixin = c({
bufferish: h,
write: function(t) {
var r = this.offset ? h.prototype.slice.call(this.buffer, this.offset) : this.buffer;
...
for (var f = i - n, u = e - r, a = Math.min(f, u), s = this.slice(n, i), c = t.slice(r, e), h = 0; h < a; ++h) if (s[h] !== c[h]) {
f = s[h], u = c[h];
break;
}
